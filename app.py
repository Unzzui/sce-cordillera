...
app.title = "Dashboard SCE Cordillera"
        ...
        dbc.Collapse(
            dbc.Nav(
                [
                    ...
                    dbc.NavItem(dbc.NavLink(html.A(
                        "Contacto", href="mailto:diego.bravo@ocaglobal.com?subject=Consulta%20SCE%20Cordillera", className="nav-link-custom"))),
...
footer_content = html.Div(
    [
        ...
        [
            ...
            html.A("diego.bravo@ocaglobal.com", href="mailto:diego.bravo@ocaglobal.com?subject=Consulta%20SCE%20Cordillera",style={'color': 'inherit', 'text-decoration': 'none'}),
...
app.layout = dbc.Container(
    ...
    children=[
        ...
        dbc.Row(
            dbc.Col(html.H1("Servicio Calidad de Emergencias Cordillera",
...
def month_line_chart(active_tab):
    ...
    df_grouped_month_year_2023['Mes'] = df_grouped_month_year_2023['Mes'].apply(
        lambda month: calendar.month_abbr[month])
    df_grouped_month_year_2022['Cumplimiento'] /= 100  # Multiplica por 100 para obtener un rango de 0 a 100
    df_grouped_month_year_2023['Cumplimiento'] /= 100  # Multiplica por 100 para obtener un rango de 0 a 100
